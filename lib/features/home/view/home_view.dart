...
class _HomeViewState extends State<HomeView>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text(FlupS.of(context).home),
          centerTitle: false,
          titleSpacing: 8,
          actions: [
            if (isMockOn)
        ...
        Positioned.fill(
          child: Column(children: [
            Builder(builder: (context) {
              ...
              final boxWidth =
                  width / 2 > height / 4 ? height / 3.5 * 2 : width;
              ...
              return SizedBox(
                ...
                child: GridView(
                  ...
                  children: [
                    HomeGridTile(
                        title: FlupS.of(context).search,
                        icon: Icons.search,
                        route: const SearchRoute()),
                    HomeGridTile(
                        title: FlupS.of(context).playlists,
                        icon: Icons.music_note,
                        route: const AllPlaylistsRoute()),
                    HomeGridTile(
                        title: FlupS.of(context).nowPlaying,
                        icon: Icons.play_arrow,
                        route: const NowPlayingRoute()),
                    HomeGridTile(
                        title: FlupS.of(context).profileMenu,
                        icon: Icons.menu,
                        route: const ProfileMenuRoute()),
                  ],
                ),
              );
            }),
            ...
            ValueListenableBuilder(
                valueListenable: FlupKApp.of(context).currentFish,
                builder: (_, value, __) => value.icon.image()),
            const Spacer(flex: 2),
          ]),
        ),
        Builder(builder: (context) {
          ...
          return Positioned(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) => Transform.translate(
                offset: Offset(
                    0,
                    miniPlayerView.preferredSize.height *
