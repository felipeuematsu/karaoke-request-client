...
Future<void> main() async {
  ...
  runApp(FlupKApp(
      initialDarkModeState: appDB.darkMode, initialLocale: appDB.locale));
}

class FlupKApp extends StatefulWidget {
  const FlupKApp(
      {Key? key,
      required this.initialDarkModeState,
  ...
  static _FlupKAppState of(BuildContext context) =>
      context.findAncestorStateOfType<_FlupKAppState>()!;
            ...
            builder: (context, isDarkMode, child) => ValueListenableBuilder(
              ...
              builder: (context, locale, child) => MaterialApp.router(
                ...
                theme: createWithCustomizations(
                  ...
                  colorScheme:
                      fish.colorScheme(context, lightScheme, lightCustomColors),
                  extensions: [lightCustomColors],
                ),
                darkTheme: createWithCustomizations(
                  textTheme: darkTextTheme,
                  colorScheme:
                      fish.colorScheme(context, darkScheme, darkCustomColors),
